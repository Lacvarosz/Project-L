...
class Tile():
    def __init__(self, assets:dict, type_t :str, variant :int, pos :Position, size :tuple[int, int] = (16, 16), collision :tuple[int, int, int, int] = (0,0,16,16)) -> None:
        self.type = type_t
        self.variant = variant
        self.pos = pos
        self.size = size
        self.surf = assets[type_t][variant-1]
